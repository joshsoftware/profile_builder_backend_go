...
func (_m *EducationService) CreateEducation(ctx context.Context, eduDetail specs.CreateEducationRequest, ID int) (int, error) {
...
func (_m *EducationService) GetEducation(ctx context.Context, profileID int) ([]specs.EducationResponse, error) {
...
func (_m *EducationService) UpdateEducation(ctx context.Context, profileID string, eduID string, req specs.UpdateEducationRequest) (int, error) {
