...
type AchievementService interface {
	CreateAchievement(ctx context.Context, cDetail dto.CreateAchievementRequest, ID string) (profileID int, err error)
	UpdateAchievement(ctx context.Context, profileID string, eduID string, req dto.UpdateAchievementRequest) (id int, err error)
}

// CreateAchievement : Service layer function adds certicates details to a user profile.
func (achSvc *service) CreateAchievement(ctx context.Context, cDetail dto.CreateAchievementRequest, ID string) (profileID int, err error) {
...
func (achSvc *service) UpdateAchievement(ctx context.Context, profileID string, eduID string, req dto.UpdateAchievementRequest) (id int, err error) {
